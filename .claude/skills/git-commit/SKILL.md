...
### Scope Examples (Volantic ERP modules)
- Fachmodul: `iam`, `stammdaten`, `lager`, `verkauf`, `hr`, `buchhaltung`
- Querschnitt: `core`, `api`, `sdk`, `workflow`, `rbac`, `belege`
- Infrastruktur: `db`, `flyway`, `config`, `build`, `ci`
- Komponente: `plugin-loader`, `event-bus`, `audit-trail`, `e-rechnung`
